...
variables = ['x_0', 'x_1', 'x_2', 'x_3', 'x_4', 'r_0', 'b_0', 'BLANK']
...
G.add_edge(buoy_factor_name_1, variables[6])

buoy_factor_name_3 = 'Buoy Factor 3'
G.add_node(buoy_factor_name_3, bipartite=1)
G.add_edge(buoy_factor_name_3, variables[3])
G.add_edge(buoy_factor_name_3, variables[6])

# rope detection
rope_factor_name_2 = 'Buoy Factor 2'
G.add_node(rope_factor_name_2, bipartite=1)
G.add_edge(rope_factor_name_2, variables[2])
G.add_edge(rope_factor_name_2, variables[5])
...
positions = {
    ...
    buoy_factor_name_3: calculate_midpoint(x_3_pos, b_0_pos),
    'BLANK': (x_4_pos[0] + 0.75, 0)
...
node_colors = {
    ...
    'x_4': variable_color,
    'r_0': rope_color,
    rope_prior_factor: map_prior_color,
    rope_factor_name_2: range_bearing_color,
    'b_0': buoy_color,
    buoy_prior_factor: map_prior_color,
    buoy_factor_name_1: range_bearing_color,
    buoy_factor_name_3: range_bearing_color,
    'BLANK': 'white'
...
node_sizes = {
    ...
    buoy_factor_name_3: factor_size,
...
nx.draw_networkx_edges(G, pos=positions, edgelist=[('x_4', 'BLANK')], style='dashed', edge_color='black')


# Create a legend for node colors
legend_labels = ['Prior Factor', 'Map Prior Factor', 'XYH Factor', 'Range/Bearing Factor']
node_colors = [prior_color, map_prior_color, DR_color, range_bearing_color]
